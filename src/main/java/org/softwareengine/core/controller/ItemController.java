...
//            ((TableColumn) view.tableView.getColumns().get(4)).setText(lang.getWord("value"));
        ...
        private void getTableColum() throws SQLException {
            ...
            TableColumn<Integer, Item> packages = new TableColumn<>("package") ;
            TableColumn<Double, Item> value = new TableColumn<>("value/price") ;
            ...
            view.tableView.getColumns().add(packages);
            view.tableView.getColumns().add(value);
