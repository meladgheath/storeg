...
import javafx.scene.layout.BorderPane;
        ...
        public class Home {
            ...
            public Home() {
                ...
                driverButton.setMinWidth(root.getPrefWidth()  );
                driverButton.setMinHeight(root.getPrefHeight());
...
//                amountButton.setTooltip(new Tooltip(resourceBundle.getString("amounts")));
                ...
                driverButton.setGraphic(driverImageView);
